...
| **Roo-Code** | Coding assistants | Roo Code is an AI-powered autonomous coding agent, that allows the utilization and creation of different agent roles to accelerate the development process. | [Documentation](https://docs.roocode.com/providers/openai-compatible) |
