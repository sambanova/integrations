...
| **Composio** | Tool and Integrations / Tool Use | Composio is a platform that equips AI agents and large language models (LLMs) with real-world integrations by providing a unified layer for tool access and function calling | [Documentation](./composio) |
...
| **OGX** | LLM frameworks  | OGX (formerly Llama Stack) is an open-source, OpenAI-compatible API server for building AI applications with any model and any infrastructure. | [Demo code](./ogx/README.md) |
...
| **Vapi** | LLM frameworks | Vapi is the developer platform for building voice AI agents. It handles the complex infrastructure so users can focus on creating great voice experiences. | [Demo code](./vapi) |
